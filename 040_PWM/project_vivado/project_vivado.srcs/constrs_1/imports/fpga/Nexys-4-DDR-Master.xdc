...
set_property PULLDOWN TRUE [get_ports io_dir]
set_property PULLDOWN TRUE [get_ports io_speed[2]]
set_property PULLDOWN TRUE [get_ports io_speed[1]]
set_property PULLDOWN TRUE [get_ports io_speed[0]]
...
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { io_driverIn1 }]; #IO_L20N_T3_A19_15 Sch=ja[1]
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { io_driverIn2 }]; #IO_L21N_T3_DQS_A18_15 Sch=ja[2]
...
set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { io_dir }]; #IO_L1P_T0_AD0P_15 Sch=jb[1]
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { io_speed[2] }]; #IO_L14N_T2_SRCC_15 Sch=jb[2]
set_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33 } [get_ports { io_speed[1] }]; #IO_L13N_T2_MRCC_15 Sch=jb[3]
set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { io_speed[0] }]; #IO_L15P_T2_DQS_15 Sch=jb[4]
